...
const weddingProducts = [
    {
        ...
        image: "/placeholder-bridal-lehenga.jpg",
        price: 8999,
        originalPrice: 9999,
        rating: 5.0,
        reviews: 210,
    },
    {
        ...
        image: "/placeholder-ivory-sherwani.jpg",
        price: 7999,
        originalPrice: 8999,
        rating: 4.9,
        reviews: 180,
    ...
    {
        id: 3,
        name: "Pastel Pink Sangeet Lehenga",
        image: "/placeholder-sangeet-lehenga.jpg",
        price: 6499,
        originalPrice: 7299,
        rating: 4.8,
        reviews: 155,
    },
    {
        ...
        image: "/placeholder-wedding-tuxedo.jpg",
        price: 5999,
        originalPrice: 6999,
        rating: 4.9,
        reviews: 195,
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Find the perfect attire for every ceremony, from the engagement to the grand reception.
            </p>
          </div>
