...
const sherwaniProducts = [
    {
        id: 1,
        name: "Classic Cream Sherwani",
        image: "/placeholder-cream-sherwani.jpg",
        price: 7999,
        originalPrice: 8999,
        rating: 4.9,
        reviews: 190,
    ...
    {
        id: 2,
        name: "Indo-Western Jodhpuri Suit",
        image: "/placeholder-jodhpuri-suit.jpg",
        price: 8499,
        originalPrice: 9499,
        rating: 4.9,
        reviews: 175,
    ...
    {
        id: 3,
        name: "Royal Blue Velvet Sherwani",
        image: "/placeholder-blue-sherwani.jpg",
        price: 9999,
        originalPrice: 10999,
        rating: 5.0,
        reviews: 220,
    },
    {
        ...
        image: "/placeholder-floral-sherwani.jpg",
        price: 7299,
        originalPrice: 8299,
        rating: 4.8,
        reviews: 140,
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Regal sherwanis for grooms and groomsmen, blending tradition with modern elegance.
            </p>
          </div>
