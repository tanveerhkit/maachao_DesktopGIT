...
const exclusiveProducts = [
    {
        id: 1,
        name: "Hand-Painted Lehenga",
        image: "/placeholder-painted-lehenga.jpg",
        price: 6999,
        originalPrice: 7999,
        rating: 4.9,
        reviews: 45,
    },
    {
        ...
        image: "/placeholder-embroidered-tuxedo.jpg",
        price: 7499,
        originalPrice: 8499,
        rating: 4.9,
        reviews: 38,
...
export default function StyleaseExclusivePage() {
  return (
    <MainLayout>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Unique, one-of-a-kind pieces you won't find anywhere else.
            </p>
          </div>
