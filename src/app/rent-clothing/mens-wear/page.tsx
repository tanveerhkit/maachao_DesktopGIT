...
const mensWearProducts = [
  {
    ...
    description: "A timeless black tuxedo, perfect for formal events.",
    price: 2499,
    originalPrice: 2999,
    rating: 4.8,
    reviews: 42,
  ...
  },
  {
    ...
    description: "Elegant blue suit for business or parties.",
    price: 2699,
    originalPrice: 3199,
    rating: 4.9,
    reviews: 28,
    ...
    <MainLayout>
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-6 text-center">Men's Wear for Rent</h1>
              ...
              <div key={product.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button className="text-pink-600 hover:text-pink-700 p-2 rounded-full hover:bg-pink-50">
                      Rent Now
                    </button>
                  </div>
                </div>
