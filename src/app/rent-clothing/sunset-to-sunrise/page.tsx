...
const sunsetSunriseProducts = [
    {
        id: 1,
        name: "Flowy Maxi Dress",
        image: "/placeholder-maxi-dress.jpg",
        price: 2599,
        originalPrice: 2899,
        rating: 4.7,
        reviews: 72,
    },
    {
        ...
        image: "/placeholder-coord-set.jpg",
        price: 2299,
        originalPrice: 2599,
        rating: 4.8,
        reviews: 68,
...
export default function SunsetToSunrisePage() {
  return (
    <MainLayout>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Versatile outfits that take you from daytime adventures to late-night soirées.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {sunsetSunriseProducts.map((product) => (
