...
export const metadata = {
  title: "Hair Stylists | Hire MUA | MaaChao",
  description: "Find and book the best hair stylists near you.",
};

const artists = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Hair Stylist #${i + 1}`,
  image: "/placeholder-mua3.jpg",
  location: "Bangalore",
  price: `₹${1499 + i * 300}`,
    ...
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Hair Stylists</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Hair Stylists</h1>
