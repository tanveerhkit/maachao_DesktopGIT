...
export const metadata = {
  title: "Mehndi Artists | Hire MUA | MaaChao",
  description: "Find and book the best mehndi artists near you.",
};

const artists = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Mehndi Artist #${i + 1}`,
  image: "/placeholder-mua2.jpg",
  location: "Delhi",
  price: `₹${1999 + i * 400}`,
    ...
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Mehndi Artists</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Mehndi Artists</h1>
