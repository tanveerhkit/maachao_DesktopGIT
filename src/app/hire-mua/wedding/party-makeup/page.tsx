...
export const metadata = {
  title: "Party Makeup Artists | Hire MUA | MaaChao",
  description: "Find and book the best party makeup artists near you.",
};

const artists = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Party Makeup MUA #${i + 1}`,
  image: "/placeholder-mua1.jpg",
  location: "Mumbai",
  price: `₹${2999 + i * 400}`,
  rating: (4 + (i % 2) * 0.5).toFixed(1),
}));

export default function PartyMakeupMUA() {
  return (
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Party Makeup</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Party Makeup Artists</h1>
