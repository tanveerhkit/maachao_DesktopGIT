...
export const metadata = {
  title: "Fine Art Photographers | Hire Photographer | MaaChao",
  description: "Find and book the best fine art photographers near you.",
};
...
export default function FineArtPhotographers() {
  return (
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Fine Art</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Fine Art Photographers</h1>
