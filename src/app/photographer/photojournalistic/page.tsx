...
export const metadata = {
  title: "Photojournalistic Photographers | Hire Photographer | MaaChao",
  description: "Find and book the best photojournalistic photographers near you.",
};
...
export default function PhotojournalisticPhotographers() {
  return (
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <Link href="/hire-mua" className="hover:text-brand-orange">Hire MUA</Link>
          <span className="mx-2">/</span>
          <Link href="/hire-mua/photographers" className="hover:text-brand-orange">Photographers</Link>
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Photojournalistic</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Photojournalistic Photographers</h1>
