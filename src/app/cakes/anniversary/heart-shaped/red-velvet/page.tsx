...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Red Velvet Heart Cake #${i + 1}`,
    description: "A classic, decadent red velvet cake in a romantic heart shape.",
    price: 1199 + i * 130,
    discountPrice: i % 3 === 0 ? 1099 + i * 130 : null,
    rating: 4.9,
    reviews: 280 + i * 28,
    category: "Red Velvet Heart Cakes",
    delivery: "Today",
...
export default function RedVelvetHeartCakesPage() {
  return (
    <>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Heart-Shaped Red Velvet Cakes</h1>
          <p className="text-gray-700 mb-4">2900 reviews</p>
