...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Custom Heart Cake #${i + 1}`,
    description: "Design your own heart-shaped cake for a truly personal touch.",
    price: 1699 + i * 200,
    discountPrice: null,
    rating: 5.0,
    reviews: 350 + i * 35,
    category: "Custom Heart Cakes",
    delivery: "3-5 days",
...
export default function CustomHeartCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Custom</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Custom Heart-Shaped Cakes</h1>
