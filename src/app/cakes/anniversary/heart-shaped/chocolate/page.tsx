...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Chocolate Heart Cake #${i + 1}`,
    description: "Indulge in a rich, decadent chocolate cake, perfectly shaped for romance.",
    price: 1299 + i * 140,
    discountPrice: i % 2 === 0 ? 1199 + i * 140 : null,
    rating: 5.0,
    reviews: 320 + i * 32,
    category: "Chocolate Heart Cakes",
    delivery: "Tomorrow",
...
export default function ChocolateHeartCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/anniversary/heart-shaped" className="hover:text-brand-orange">Heart-shaped Cakes</Link>
          <span className="mx-2">/</span>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Heart-Shaped Chocolate Cakes</h1>
