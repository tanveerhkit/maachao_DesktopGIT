...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Heart-shaped Red Velvet Cake #${i + 1}`,
    description: "A romantic heart-shaped cake for your anniversary.",
    price: 1099 + i * 120,
    discountPrice: i % 4 === 0 ? 999 + i * 120 : null,
    rating: 4.7 + (i % 3) / 10,
    reviews: 55 + i * 8,
    category: "Heart-shaped Cakes",
    delivery: "Tomorrow",
...
const categories = [
    { name: "All Heart-shaped", href: "/cakes/anniversary/heart-shaped" },
    { name: "Red Velvet", href: "/cakes/anniversary/heart-shaped/red-velvet" },
    { name: "Chocolate", href: "/cakes/anniversary/heart-shaped/chocolate" },
    { name: "Strawberry", href: "/cakes/anniversary/heart-shaped/strawberry" },
    { name: "Custom", href: "/cakes/anniversary/heart-shaped/custom" },
];

export default function HeartShapedCakesPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Heart-shaped Cakes</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Heart-shaped Cakes</h1>
          <p className="text-gray-700 mb-4">753 reviews</p>
