...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Strawberry Heart Cake #${i + 1}`,
    description: "A sweet and fruity strawberry cake, lovingly shaped like a heart.",
    price: 1099 + i * 120,
    discountPrice: i % 4 === 0 ? 999 + i * 120 : null,
    rating: 4.8,
    reviews: 260 + i * 26,
    category: "Strawberry Heart Cakes",
    delivery: "Today",
...
export default function StrawberryHeartCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Strawberry</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Heart-Shaped Strawberry Cakes</h1>
          <p className="text-gray-700 mb-4">2700 reviews</p>
