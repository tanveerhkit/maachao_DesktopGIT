...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Elegant Tiered Cake #${i + 1}`,
    description: "A stunning multi-layered cake for grand celebrations.",
    price: 2499 + i * 200,
    discountPrice: i % 5 === 0 ? 2299 + i * 200 : null,
    rating: 4.9,
    reviews: 68 + i * 10,
...
const categories = [
    { name: "All Tiered Cakes", href: "/cakes/anniversary/tiered" },
    { name: "2-Tier", href: "/cakes/anniversary/tiered/2-tier" },
    { name: "3-Tier", href: "/cakes/anniversary/tiered/3-tier" },
    { name: "Wedding", href: "/cakes/anniversary/tiered/wedding" },
    { name: "Classic", href: "/cakes/anniversary/tiered/classic" },
];
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Tiered Cakes</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Tiered Cakes</h1>
          <p className="text-gray-700 mb-4">421 reviews</p>
