...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Wedding Tiered Cake #${i + 1}`,
    description: "The perfect centerpiece for your special day - an exquisite tiered wedding cake.",
    price: 7999 + i * 700,
    discountPrice: null,
    rating: 5.0,
    reviews: 500 + i * 50,
...
export default function WeddingTieredCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Wedding</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Tiered Wedding Cakes</h1>
          <p className="text-gray-700 mb-4">5500 reviews</p>
