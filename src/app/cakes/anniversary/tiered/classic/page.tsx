...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Classic Tiered Cake #${i + 1}`,
    description: "A timeless and elegant tiered cake for any special occasion.",
    price: 3499 + i * 300,
    discountPrice: i % 3 === 0 ? 3299 + i * 300 : null,
    rating: 4.8,
    reviews: 350 + i * 35,
    category: "Classic Tiered Cakes",
    delivery: "2 days",
...
export default function ClassicTieredCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/anniversary/tiered" className="hover:text-brand-orange">Tiered Cakes</Link>
          <span className="mx-2">/</span>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Classic Tiered Cakes</h1>
