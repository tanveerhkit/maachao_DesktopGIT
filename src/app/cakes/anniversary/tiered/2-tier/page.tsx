...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `2-Tier Anniversary Cake #${i + 1}`,
    description: "An elegant 2-tier cake, perfect for a memorable anniversary celebration.",
    price: 2999 + i * 250,
    discountPrice: i % 4 === 0 ? 2799 + i * 250 : null,
    rating: 4.9,
    reviews: 300 + i * 30,
...
export default function TwoTierCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">2-Tier</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">2-Tier Anniversary Cakes</h1>
