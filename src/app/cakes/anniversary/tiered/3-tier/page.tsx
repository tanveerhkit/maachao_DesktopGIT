...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `3-Tier Anniversary Cake #${i + 1}`,
    description: "A grand 3-tier cake for a truly spectacular anniversary.",
    price: 4999 + i * 450,
    discountPrice: i % 5 === 0 ? 4799 + i * 450 : null,
    rating: 5.0,
    reviews: 400 + i * 40,
    category: "3-Tier Cakes",
    delivery: "3 days",
...
export default function ThreeTierCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">3-Tier</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">3-Tier Anniversary Cakes</h1>
          <p className="text-gray-700 mb-4">4200 reviews</p>
