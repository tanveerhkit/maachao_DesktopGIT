...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Adorable Diaper Cake #${i + 1}`,
    description: "A fun and practical gift for baby showers.",
    price: 1999 + i * 180,
    discountPrice: i % 3 === 0 ? 1799 + i * 180 : null,
    rating: 4.9,
    reviews: 88 + i * 12,
    category: "Diaper Cakes",
    delivery: "3 days",
...
const categories = [
    { name: "All Diaper Cakes", href: "/cakes/baby-shower/diaper" },
    { name: "For Boys", href: "/cakes/baby-shower/diaper/for-boys" },
    { name: "For Girls", href: "/cakes/baby-shower/diaper/for-girls" },
    { name: "Neutral", href: "/cakes/baby-shower/diaper/neutral" },
    { name: "Themed", href: "/cakes/baby-shower/diaper/themed" },
];

export default function DiaperCakesPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Diaper Cakes</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Diaper Cakes</h1>
          <p className="text-gray-700 mb-4">312 reviews</p>
