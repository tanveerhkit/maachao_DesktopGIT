...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Themed Diaper Cake #${i + 1}`,
    description: "A creative diaper cake with fun themes for a memorable baby shower.",
    price: 2299 + i * 210,
    discountPrice: i % 3 === 0 ? 2099 + i * 210 : null,
    rating: 5.0,
    reviews: 160 + i * 16,
    category: "Themed Diaper Cakes",
    delivery: "4 days",
...
export default function ThemedDiaperCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Themed</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Themed Diaper Cakes</h1>
          <p className="text-gray-700 mb-4">1700 reviews</p>
