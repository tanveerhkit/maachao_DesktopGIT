...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Diaper Cake for Boys #${i + 1}`,
    description: "A playful and practical diaper cake, perfect for welcoming a baby boy.",
    price: 2099 + i * 190,
    discountPrice: i % 3 === 0 ? 1899 + i * 190 : null,
    rating: 4.9,
    reviews: 120 + i * 12,
    category: "Diaper Cakes for Boys",
    delivery: "3 days",
...
export default function DiaperCakesForBoysPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">For Boys</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Diaper Cakes for Boys</h1>
          <p className="text-gray-700 mb-4">1400 reviews</p>
