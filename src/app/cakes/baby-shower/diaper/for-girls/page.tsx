...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Diaper Cake for Girls #${i + 1}`,
    description: "A sweet and practical diaper cake, perfect for welcoming a baby girl.",
    price: 2099 + i * 190,
    discountPrice: i % 3 === 0 ? 1899 + i * 190 : null,
    rating: 4.9,
    reviews: 130 + i * 13,
    category: "Diaper Cakes for Girls",
    delivery: "3 days",
...
export default function DiaperCakesForGirlsPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/baby-shower/diaper" className="hover:text-brand-orange">Diaper Cakes</Link>
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">For Girls</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Diaper Cakes for Girls</h1>
