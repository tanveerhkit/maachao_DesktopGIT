...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Neutral Diaper Cake #${i + 1}`,
    description: "A gender-neutral diaper cake, perfect for any baby shower.",
    price: 2099 + i * 190,
    discountPrice: i % 3 === 0 ? 1899 + i * 190 : null,
    rating: 4.9,
    reviews: 110 + i * 11,
    category: "Neutral Diaper Cakes",
    delivery: "3 days",
...
export default function NeutralDiaperCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Neutral</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Neutral Diaper Cakes</h1>
          <p className="text-gray-700 mb-4">1300 reviews</p>
