...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Smash Cake for Boys & Girls #${i + 1}`,
    description: "Fun and colorful smash cakes suitable for both baby boys and girls.",
    price: 899 + i * 100,
    discountPrice: i % 4 === 0 ? 799 + i * 100 : null,
    rating: 4.8,
    reviews: 140 + i * 14,
    category: "Smash Cakes for Boys & Girls",
    delivery: "Tomorrow",
...
export default function BoysGirlsSmashCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">For Boys & Girls</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Smash Cakes for Boys & Girls</h1>
          <p className="text-gray-700 mb-4">1500 reviews</p>
