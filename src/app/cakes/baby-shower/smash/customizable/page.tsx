...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Customizable Smash Cake #${i + 1}`,
    description: "Create a unique smash cake by choosing your own colors and theme.",
    price: 1099 + i * 120,
    discountPrice: null,
    rating: 5.0,
    reviews: 180 + i * 18,
    category: "Customizable Smash Cakes",
    delivery: "2-3 days",
...
export default function CustomizableSmashCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Customizable</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Customizable Smash Cakes</h1>
          <p className="text-gray-700 mb-4">2000 reviews</p>
