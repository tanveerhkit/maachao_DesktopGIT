...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Fun Smash Cake #${i + 1}`,
    description: "A fun and messy cake for a memorable first birthday.",
    price: 799 + i * 90,
    discountPrice: i % 4 === 0 ? 699 + i * 90 : null,
    rating: 4.8,
    reviews: 77 + i * 9,
...
const categories = [
    { name: "All Smash Cakes", href: "/cakes/baby-shower/smash" },
    { name: "For First Birthday", href: "/cakes/baby-shower/smash/for-first-birthday" },
    { name: "Boys & Girls", href: "/cakes/baby-shower/smash/boys-girls" },
    { name: "Customizable", href: "/cakes/baby-shower/smash/customizable" },
];

export default function SmashCakesPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Smash Cakes</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Smash Cakes</h1>
          <p className="text-gray-700 mb-4">543 reviews</p>
