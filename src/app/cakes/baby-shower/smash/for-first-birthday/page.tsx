...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `First Birthday Smash Cake #${i + 1}`,
    description: "The perfect cake for a memorable first birthday photoshoot.",
    price: 899 + i * 100,
    discountPrice: i % 3 === 0 ? 799 + i * 100 : null,
    rating: 4.9,
    reviews: 150 + i * 15,
    category: "First Birthday Smash Cakes",
    delivery: "Tomorrow",
...
export default function FirstBirthdaySmashCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/baby-shower/smash" className="hover:text-brand-orange">Smash Cakes</Link>
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">For First Birthday</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">First Birthday Smash Cakes</h1>
          <p className="text-gray-700 mb-4">1600 reviews</p>
