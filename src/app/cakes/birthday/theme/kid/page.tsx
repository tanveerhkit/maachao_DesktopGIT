...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Fun Kids Theme Cake #${i + 1}`,
    description: "A fun and exciting cake that kids will absolutely love.",
    price: 999 + i * 110,
    discountPrice: i % 3 === 0 ? 899 + i * 110 : null,
    rating: 4.9,
    reviews: 112 + i * 12,
    category: "Kids Cakes",
    delivery: "Today",
...
const categories = [
    { name: "All Kids Cakes", href: "/cakes/birthday/theme/kid" },
    { name: "Cartoon", href: "/cakes/birthday/theme/kid/cartoon" },
    { name: "Superhero", href: "/cakes/birthday/theme/kid/superhero" },
    { name: "Princess", href: "/cakes/birthday/theme/kid/princess" },
    { name: "Jungle Theme", href: "/cakes/birthday/theme/kid/jungle-theme" },
];

export default function KidsCakesPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">For Kids</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Kids Theme Cakes</h1>
          <p className="text-gray-700 mb-4">1204 reviews</p>
