...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Kid's Superhero Cake #${i + 1}`,
    description: "A heroic cake for your little superhero's big day.",
    price: 1199 + i * 130,
    discountPrice: i % 3 === 0 ? 1099 + i * 130 : null,
    rating: 5.0,
    reviews: 130 + i * 14,
    category: "Superhero Cakes for Kids",
    delivery: "Tomorrow",
...
export default function SuperheroCakesForKidsPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Superhero</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Superhero Themed Cakes for Kids</h1>
          <p className="text-gray-700 mb-4">1480 reviews</p>
