...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    ...
    description: "A delightful cake featuring their favorite cartoon character.",
    price: 1099 + i * 120,
    discountPrice: i % 3 === 0 ? 999 + i * 120 : null,
    rating: 4.9,
    reviews: 120 + i * 13,
    category: "Cartoon Cakes for Kids",
    delivery: "Today",
...
export default function CartoonCakesForKidsPage() {
  return (
    <>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Cartoon Themed Cakes</h1>
          <p className="text-gray-700 mb-4">1350 reviews</p>
