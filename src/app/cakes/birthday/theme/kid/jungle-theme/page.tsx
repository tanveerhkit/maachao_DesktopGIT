...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Adventurous Jungle Cake #${i + 1}`,
    description: "A fun jungle-themed cake for a wild birthday party.",
    price: 1199 + i * 130,
    discountPrice: i % 4 === 0 ? 1099 + i * 130 : null,
    rating: 4.8,
    reviews: 110 + i * 12,
    category: "Jungle Cakes for Kids",
    delivery: "Tomorrow",
...
export default function JungleThemeCakesForKidsPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/birthday/theme/kid" className="hover:text-brand-orange">For Kids</Link>
          <span className="mx-2">/</span>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Jungle Themed Cakes for Kids</h1>
          <p className="text-gray-700 mb-4">1250 reviews</p>
