...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Enchanting Princess Cake #${i + 1}`,
    description: "A magical princess cake to make her dreams come true.",
    price: 1299 + i * 140,
    discountPrice: i % 3 === 0 ? 1199 + i * 140 : null,
    rating: 5.0,
    reviews: 140 + i * 15,
    category: "Princess Cakes for Kids",
    delivery: "Tomorrow",
...
export default function PrincessCakesForKidsPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Princess</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Princess Themed Cakes for Kids</h1>
          <p className="text-gray-700 mb-4">1620 reviews</p>
