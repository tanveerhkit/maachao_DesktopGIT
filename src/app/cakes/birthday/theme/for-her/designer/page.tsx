...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Chic Designer Cake #${i + 1}`,
    description: "A high-fashion inspired designer cake that's as stylish as she is.",
    price: 1499 + i * 150,
    discountPrice: i % 4 === 0 ? 1399 + i * 150 : null,
    rating: 4.9,
    reviews: 85 + i * 11,
    category: "Designer Cakes for Her",
    delivery: "2 days",
...
export default function DesignerCakesForHerPage() {
  return (
    <>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Designer Cakes for Her</h1>
