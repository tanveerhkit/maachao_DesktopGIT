...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Decadent Chocolate Cake #${i + 1}`,
    description: "A rich and indulgent chocolate cake, the perfect treat for her.",
    price: 1099 + i * 110,
    discountPrice: i % 4 === 0 ? 999 + i * 110 : null,
    rating: 4.9,
    reviews: 95 + i * 12,
    category: "Chocolate Cakes for Her",
    delivery: "Today",
...
export default function ChocolateCakesForHerPage() {
  return (
    <>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Chocolate Cakes for Her</h1>
          <p className="text-gray-700 mb-4">1125 reviews</p>
