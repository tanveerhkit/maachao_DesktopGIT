...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Beautiful Floral Cake #${i + 1}`,
    description: "A stunning cake adorned with edible flowers, perfect for her.",
    price: 1299 + i * 140,
    discountPrice: i % 3 === 0 ? 1199 + i * 140 : null,
    rating: 4.9,
    reviews: 75 + i * 10,
    category: "Floral Cakes for Her",
    delivery: "Tomorrow",
...
export default function FloralCakesForHerPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Floral</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Floral Cakes for Her</h1>
          <p className="text-gray-700 mb-4">897 reviews</p>
