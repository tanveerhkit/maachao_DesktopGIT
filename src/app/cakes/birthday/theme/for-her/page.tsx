...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Elegant Cake for Her #${i + 1}`,
    description: "A beautiful and elegant cake, perfect for her special day.",
    price: 1199 + i * 130,
    discountPrice: i % 3 === 0 ? 1099 + i * 130 : null,
    rating: 4.8,
    reviews: 65 + i * 9,
    category: "Cakes for Her",
    delivery: "Tomorrow",
...
const categories = [
    { name: "All Cakes for Her", href: "/cakes/birthday/theme/for-her" },
    { name: "Floral", href: "/cakes/birthday/theme/for-her/floral" },
    { name: "Designer", href: "/cakes/birthday/theme/for-her/designer" },
    { name: "Chocolate", href: "/cakes/birthday/theme/for-her/chocolate" },
    { name: "Red Velvet", href: "/cakes/birthday/theme/for-her/red-velvet" },
];

export default function CakesForHerPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">For Her</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Cakes for Her</h1>
          <p className="text-gray-700 mb-4">654 reviews</p>
