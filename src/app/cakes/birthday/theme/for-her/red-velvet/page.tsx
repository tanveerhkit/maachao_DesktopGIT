...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Classic Red Velvet Cake #${i + 1}`,
    description: "A timeless Red Velvet cake with cream cheese frosting, a perfect gift.",
    price: 1199 + i * 120,
    discountPrice: i % 4 === 0 ? 1099 + i * 120 : null,
    rating: 5.0,
    reviews: 105 + i * 13,
    category: "Red Velvet Cakes for Her",
    delivery: "Tomorrow",
...
export default function RedVelvetCakesForHerPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/birthday/theme/for-her" className="hover:text-brand-orange">For Her</Link>
          <span className="mx-2">/</span>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Red Velvet Cakes for Her</h1>
          <p className="text-gray-700 mb-4">1280 reviews</p>
