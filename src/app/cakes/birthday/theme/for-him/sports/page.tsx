...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Sports Fanatic Cake #${i + 1}`,
    description: "The perfect cake for the sports lover, featuring their favorite team or sport.",
    price: 1399 + i * 140,
    discountPrice: i % 4 === 0 ? 1299 + i * 140 : null,
    rating: 4.8,
    reviews: 70 + i * 9,
    category: "Sports Cakes for Him",
    delivery: "Tomorrow",
...
export default function SportsCakesForHimPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Sports</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Sports Themed Cakes for Him</h1>
          <p className="text-gray-700 mb-4">880 reviews</p>
