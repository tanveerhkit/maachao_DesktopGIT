...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Timeless Classic Cake #${i + 1}`,
    description: "A sophisticated and classic cake, perfect for any celebration.",
    price: 1099 + i * 110,
    discountPrice: i % 4 === 0 ? 999 + i * 110 : null,
    rating: 4.9,
    reviews: 90 + i * 11,
    category: "Classic Cakes for Him",
    delivery: "Today",
...
export default function ClassicCakesForHimPage() {
  return (
    <>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Classic Cakes for Him</h1>
          <p className="text-gray-700 mb-4">1050 reviews</p>
