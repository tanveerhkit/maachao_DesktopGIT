...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Tech Gadget Cake #${i + 1}`,
    description: "For the tech-savvy man, a cake designed like his favorite gadget.",
    price: 1499 + i * 150,
    discountPrice: i % 3 === 0 ? 1399 + i * 150 : null,
    rating: 4.7,
    reviews: 75 + i * 8,
    category: "Gadget Cakes for Him",
    delivery: "2 days",
...
export default function GadgetsCakesForHimPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Gadgets</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Gadget Themed Cakes for Him</h1>
          <p className="text-gray-700 mb-4">810 reviews</p>
