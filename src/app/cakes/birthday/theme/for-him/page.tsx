...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Masculine Theme Cake #${i + 1}`,
    description: "A stylish and modern cake, perfect for his special day.",
    price: 1199 + i * 130,
    discountPrice: i % 3 === 0 ? 1099 + i * 130 : null,
    rating: 4.8,
    reviews: 62 + i * 8,
    category: "Cakes for Him",
    delivery: "Tomorrow",
...
const categories = [
    { name: "All Cakes for Him", href: "/cakes/birthday/theme/for-him" },
    { name: "Sports", href: "/cakes/birthday/theme/for-him/sports" },
    { name: "Superheroes", href: "/cakes/birthday/theme/for-him/superheroes" },
    { name: "Gadgets", href: "/cakes/birthday/theme/for-him/gadgets" },
    { name: "Classic", href: "/cakes/birthday/theme/for-him/classic" },
];

export default function CakesForHimPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">For Him</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Cakes for Him</h1>
          <p className="text-gray-700 mb-4">598 reviews</p>
