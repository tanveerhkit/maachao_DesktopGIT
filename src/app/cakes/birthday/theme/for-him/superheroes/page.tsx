...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Awesome Superhero Cake #${i + 1}`,
    description: "Unleash his inner hero with a cake featuring his favorite superhero.",
    price: 1399 + i * 140,
    discountPrice: i % 4 === 0 ? 1299 + i * 140 : null,
    rating: 4.9,
    reviews: 80 + i * 10,
    category: "Superhero Cakes for Him",
    delivery: "Tomorrow",
...
export default function SuperheroesCakesForHimPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/birthday/theme/for-him" className="hover:text-brand-orange">For Him</Link>
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Superheroes</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Superhero Themed Cakes for Him</h1>
          <p className="text-gray-700 mb-4">920 reviews</p>
