...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Cartoon Character Cake #${i + 1}`,
    description: "Bring your favorite cartoon characters to life with these amazing cakes.",
    price: 1099 + i * 120,
    discountPrice: i % 3 === 0 ? 999 + i * 120 : null,
    rating: 4.9,
    reviews: 150 + i * 15,
...
const categories = [
    { name: "All Cartoon Cakes", href: "/cakes/birthday/theme/cartoon" },
    { name: "Mickey Mouse", href: "/cakes/birthday/theme/cartoon/mickey-mouse" },
    { name: "Peppa Pig", href: "/cakes/birthday/theme/cartoon/peppa-pig" },
    { name: "Doraemon", href: "/cakes/birthday/theme/cartoon/doraemon" },
    { name: "Paw Patrol", href: "/cakes/birthday/theme/cartoon/paw-patrol" },
];

export default function CartoonCakesPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Cartoon</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Cartoon Theme Cakes</h1>
          <p className="text-gray-700 mb-4">1650 reviews</p>
