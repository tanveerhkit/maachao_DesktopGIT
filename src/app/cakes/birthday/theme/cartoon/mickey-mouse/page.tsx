...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Mickey Mouse Fun Cake #${i + 1}`,
    description: "A fun and cheerful cake featuring the one and only Mickey Mouse.",
    price: 1199 + i * 130,
    discountPrice: i % 3 === 0 ? 1099 + i * 130 : null,
    rating: 4.9,
    reviews: 180 + i * 18,
    category: "Mickey Mouse Cakes",
    delivery: "Today",
...
export default function MickeyMouseCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Mickey Mouse</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Mickey Mouse Theme Cakes</h1>
          <p className="text-gray-700 mb-4">1850 reviews</p>
