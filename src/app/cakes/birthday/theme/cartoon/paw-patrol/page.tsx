...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Paw Patrol Rescue Cake #${i + 1}`,
    description: "No job is too big, no pup is too small! A cake for the Paw Patrol fan.",
    price: 1299 + i * 140,
    discountPrice: i % 4 === 0 ? 1199 + i * 140 : null,
    rating: 5.0,
    reviews: 190 + i * 19,
    category: "Paw Patrol Cakes",
    delivery: "Tomorrow",
...
export default function PawPatrolCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Paw Patrol</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Paw Patrol Theme Cakes</h1>
