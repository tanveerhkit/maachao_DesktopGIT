...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Peppa Pig Adventure Cake #${i + 1}`,
    description: "Jump in muddy puddles of fun with a Peppa Pig themed cake.",
    price: 1099 + i * 110,
...
export default function PeppaPigCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Peppa Pig</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Peppa Pig Theme Cakes</h1>
          <p className="text-gray-700 mb-4">1750 reviews</p>
