...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Unicorn Birthday Theme Cake #${i + 1}`,
    description: "A magical unicorn cake for special birthdays.",
    price: 999 + i * 100,
    discountPrice: i % 3 === 0 ? 899 + i * 100 : null,
    rating: 4.5 + (i % 5) / 10,
    reviews: 28 + i * 5,
...
const categories = [
    { name: "All Theme Cakes", href: "/cakes/birthday/theme" },
    { name: "For Kids", href: "/cakes/birthday/theme/kid" },
    { name: "For Her", href: "/cakes/birthday/theme/for-her" },
    { name: "For Him", href: "/cakes/birthday/theme/for-him" },
    { name: "Cartoon", href: "/cakes/birthday/theme/cartoon" },
];

export default function ThemeCakesPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Theme Cakes</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Theme Cakes</h1>
          <p className="text-gray-700 mb-4">1,234 reviews</p>
