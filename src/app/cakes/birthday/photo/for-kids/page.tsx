...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Kids Photo Cake #${i + 1}`,
    description: "Surprise your little one with a fun photo cake featuring their favorite moments.",
    price: 1199 + i * 140,
    discountPrice: i % 3 === 0 ? 1099 + i * 140 : null,
    rating: 4.8,
    reviews: 180 + i * 18,
    category: "Kids Photo Cakes",
    delivery: "Today",
...
export default function ForKidsPhotoCakesPage() {
  return (
    <>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Photo Cakes for Kids</h1>
          <p className="text-gray-700 mb-4">1900 reviews</p>
