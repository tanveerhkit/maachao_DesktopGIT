...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Custom Photo Cake #${i + 1}`,
    description: "A personalized cake with your favorite photo.",
    price: 1299 + i * 150,
    discountPrice: i % 5 === 0 ? 1199 + i * 150 : null,
    rating: 4.8 + (i % 2) / 10,
    reviews: 42 + i * 7,
...
const categories = [
    { name: "All Photo Cakes", href: "/cakes/birthday/photo" },
    { name: "Birthday", href: "/cakes/birthday/photo/birthday" },
    { name: "Anniversary", href: "/cakes/birthday/photo/anniversary" },
    { name: "For Kids", href: "/cakes/birthday/photo/for-kids" },
    { name: "Corporate", href: "/cakes/birthday/photo/corporate" },
];
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Photo Cakes</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Photo Cakes</h1>
          <p className="text-gray-700 mb-4">876 reviews</p>
