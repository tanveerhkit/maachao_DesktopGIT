...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Birthday Photo Cake #${i + 1}`,
    description: "Celebrate a special birthday with a personalized photo cake.",
    price: 1399 + i * 160,
    discountPrice: i % 3 === 0 ? 1299 + i * 160 : null,
    rating: 4.9,
    reviews: 200 + i * 20,
    category: "Birthday Photo Cakes",
    delivery: "Today",
...
export default function BirthdayPhotoCakesPage() {
  return (
    <>
      ...
      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Birthday Photo Cakes</h1>
          <p className="text-gray-700 mb-4">2100 reviews</p>
