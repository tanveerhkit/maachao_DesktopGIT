...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Corporate Photo Cake #${i + 1}`,
    description: "Add a professional touch to your corporate events with a logo or team photo cake.",
    price: 1599 + i * 180,
    discountPrice: i % 5 === 0 ? 1499 + i * 180 : null,
    rating: 4.9,
    reviews: 250 + i * 25,
    category: "Corporate Photo Cakes",
    delivery: "2 days",
...
export default function CorporatePhotoCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Corporate</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Corporate Photo Cakes</h1>
          <p className="text-gray-700 mb-4">2600 reviews</p>
