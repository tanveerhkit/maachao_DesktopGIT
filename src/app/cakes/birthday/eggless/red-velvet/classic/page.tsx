...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Timeless Classic Red Velvet Cake #${i + 1}`,
    description: "The original, unbeatable eggless red velvet cake. A true classic.",
    price: 999 + i * 100,
    discountPrice: i % 4 === 0 ? 899 + i * 100 : null,
    rating: 5.0,
    reviews: 300 + i * 28,
    category: "Classic Red Velvet Eggless",
    delivery: "Today",
...
export default function ClassicRedVelvetEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Classic</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Classic Red Velvet Eggless Cakes</h1>
          <p className="text-gray-700 mb-4">3200 reviews</p>
