...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Romantic Heart-Shaped Red Velvet Cake #${i + 1}`,
    description: "Say 'I love you' with a stunning, heart-shaped eggless red velvet cake.",
    price: 1199 + i * 120,
    discountPrice: i % 2 === 0 ? 1099 + i * 120 : null,
    rating: 5.0,
    reviews: 350 + i * 35,
    category: "Heart-Shaped Red Velvet Eggless",
    delivery: "Tomorrow",
...
export default function HeartShapedRedVelvetEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Heart-Shaped</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Heart-Shaped Red Velvet Cakes (Eggless)</h1>
          <p className="text-gray-700 mb-4">3800 reviews</p>
