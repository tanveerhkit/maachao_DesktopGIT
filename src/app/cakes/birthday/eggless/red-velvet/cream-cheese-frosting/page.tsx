...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Cream Cheese Frosted Red Velvet Cake #${i + 1}`,
    description: "The perfect pairing: eggless red velvet cake with tangy cream cheese frosting.",
    price: 1099 + i * 110,
    discountPrice: i % 3 === 0 ? 999 + i * 110 : null,
    rating: 5.0,
    reviews: 320 + i * 30,
    category: "Cream Cheese Red Velvet Eggless",
    delivery: "Tomorrow",
...
export default function CreamCheeseRedVelvetEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/birthday/eggless/red-velvet" className="hover:text-brand-orange">Red Velvet</Link>
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Cream Cheese Frosting</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Cream Cheese Frosted Red Velvet Cakes (Eggless)</h1>
          <p className="text-gray-700 mb-4">3500 reviews</p>
