...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Velvety Red Velvet Cake #${i + 1}`,
    description: "Experience the classic, luxurious taste of our Red Velvet eggless cakes.",
    price: 999 + i * 100,
    discountPrice: i % 4 === 0 ? 899 + i * 100 : null,
    rating: 4.9,
    reviews: 250 + i * 25,
    category: "Red Velvet Eggless",
    delivery: "Today",
...
const categories = [
    { name: "All Red Velvet", href: "/cakes/birthday/eggless/red-velvet" },
    { name: "Classic", href: "/cakes/birthday/eggless/red-velvet/classic" },
    { name: "Cream Cheese Frosting", href: "/cakes/birthday/eggless/red-velvet/cream-cheese-frosting" },
    { name: "Heart-Shaped", href: "/cakes/birthday/eggless/red-velvet/heart-shaped" },
];

export default function RedVelvetEgglessCakesPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Red Velvet</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Red Velvet Eggless Cakes</h1>
          <p className="text-gray-700 mb-4">2890 reviews</p>
