...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Stylish Designer Eggless Cake #${i + 1}`,
    description: "Elegant and artistic, our designer eggless cakes are perfect for special occasions.",
    price: 1299 + i * 150,
    discountPrice: i % 4 === 0 ? 1199 + i * 150 : null,
    rating: 5.0,
    reviews: 300 + i * 30,
    category: "Designer Eggless",
    delivery: "Tomorrow",
...
const categories = ["All Designer", "Modern", "Floral", "Tiered", "Custom"];

export default function DesignerEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Designer</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Designer Eggless Cakes</h1>
