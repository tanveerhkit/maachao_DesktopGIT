...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Rich Chocolate Eggless Cake #${i + 1}`,
    description: "Indulge in the rich, decadent flavor of our best-selling chocolate eggless cakes.",
    price: 899 + i * 100,
    discountPrice: i % 4 === 0 ? 799 + i * 100 : null,
    rating: 4.9,
    reviews: 210 + i * 20,
    category: "Chocolate Eggless",
    delivery: "Today",
...
const categories = [
    { name: "All Chocolate", href: "/cakes/birthday/eggless/chocolate" },
    { name: "Dark Chocolate", href: "/cakes/birthday/eggless/chocolate/dark-chocolate" },
    { name: "Truffle", href: "/cakes/birthday/eggless/chocolate/truffle" },
    { name: "Choco-chip", href: "/cakes/birthday/eggless/chocolate/choco-chip" },
    { name: "Fudge", href: "/cakes/birthday/eggless/chocolate/fudge" },
];

export default function ChocolateEgglessCakesPage() {
    ...
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/birthday/eggless" className="hover:text-brand-orange">Eggless Cakes</Link>
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Chocolate</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Chocolate Eggless Cakes</h1>
          <p className="text-gray-700 mb-4">2450 reviews</p>
