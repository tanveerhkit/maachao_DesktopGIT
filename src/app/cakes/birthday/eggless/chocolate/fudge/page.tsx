...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Gooey Fudge Eggless Cake #${i + 1}`,
    description: "A dense, moist, and supremely chocolatey eggless fudge cake.",
    price: 1149 + i * 125,
    discountPrice: i % 4 === 0 ? 1049 + i * 125 : null,
    rating: 4.9,
    reviews: 230 + i * 20,
    category: "Fudge Eggless",
    delivery: "Tomorrow",
...
export default function FudgeEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Fudge</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Fudge Eggless Cakes</h1>
          <p className="text-gray-700 mb-4">2550 reviews</p>
