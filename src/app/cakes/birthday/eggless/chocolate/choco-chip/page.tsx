...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Crunchy Choco-Chip Eggless Cake #${i + 1}`,
    description: "A delightful eggless cake packed with delicious chocolate chips.",
    price: 949 + i * 100,
    discountPrice: i % 3 === 0 ? 849 + i * 100 : null,
    rating: 4.8,
    reviews: 200 + i * 18,
    category: "Choco-Chip Eggless",
    delivery: "Today",
...
export default function ChocoChipEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Choco-chip</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Choco-chip Eggless Cakes</h1>
          <p className="text-gray-700 mb-4">2250 reviews</p>
