...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Silky Truffle Eggless Cake #${i + 1}`,
    description: "Experience pure bliss with our smooth and silky eggless chocolate truffle cake.",
    price: 1099 + i * 120,
    discountPrice: i % 3 === 0 ? 999 + i * 120 : null,
    rating: 5.0,
    reviews: 280 + i * 25,
    category: "Truffle Eggless",
    delivery: "Today",
...
export default function TruffleEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Truffle</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Truffle Eggless Cakes</h1>
          <p className="text-gray-700 mb-4">3100 reviews</p>
