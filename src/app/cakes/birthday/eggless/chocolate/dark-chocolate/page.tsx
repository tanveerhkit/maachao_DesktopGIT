...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Intense Dark Chocolate Eggless Cake #${i + 1}`,
    description: "For the true chocolate connoisseur, an eggless cake with pure dark chocolate.",
    price: 999 + i * 110,
    discountPrice: i % 4 === 0 ? 899 + i * 110 : null,
    rating: 5.0,
    reviews: 250 + i * 22,
    category: "Dark Chocolate Eggless",
    delivery: "Today",
...
export default function DarkChocolateEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/cakes/birthday/eggless/chocolate" className="hover:text-brand-orange">Chocolate</Link>
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Dark Chocolate</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Dark Chocolate Eggless Cakes</h1>
          <p className="text-gray-700 mb-4">2800 reviews</p>
