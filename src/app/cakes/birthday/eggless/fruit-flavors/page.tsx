...
const cakes = Array.from({ length: 30 }, (_, i) => ({
    id: i + 1,
    name: `Fresh Fruit Eggless Cake #${i + 1}`,
    description: "Enjoy the refreshing taste of our fruit-flavored eggless cakes, made with fresh ingredients.",
    price: 949 + i * 100,
    discountPrice: i % 4 === 0 ? 849 + i * 100 : null,
    rating: 4.8,
    reviews: 180 + i * 15,
    category: "Fruit Flavored Eggless",
    delivery: "Today",
...
const categories = ["All Fruits", "Pineapple", "Strawberry", "Mango", "Mixed Fruit"];

export default function FruitFlavorsEgglessCakesPage() {
  return (
    <>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Fruit Flavors</span>
        </div>
      </div>

      <section className="bg-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2 text-gray-800">Fruit Flavored Eggless Cakes</h1>
          <p className="text-gray-700 mb-4">1980 reviews</p>
