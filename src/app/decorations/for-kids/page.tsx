...
export const metadata = {
  title: "For Kids Decorations | MaaChao",
  description: "Find the best party decorations for kids' birthdays and celebrations.",
};

const kidsPackages = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Kids Decoration Package #${i + 1}`,
...
export default function ForKidsDecorationsPage() {
  return (
    <MainLayout>
      ...
      <section className="container mx-auto px-4 py-4 bg-white">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">For Kids Decorations</h1>
        <p className="text-gray-700 mb-4">{kidsPackages.length * 100 + 500} reviews</p>
      </section>
      <section className="container mx-auto px-4 py-4 border-t border-b border-gray-200 bg-white">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-500">{kidsPackages.length * 100 + 500} reviews</span>
          </div>
        </div>
      </section>
