...
export const metadata = {
  title: "Romantic Decorations | MaaChao",
  description: "Find the best romantic decorations for anniversaries, proposals, and special moments.",
};

const romanticPackages = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Romantic Decoration Package #${i + 1}`,
...
export default function RomanticDecorationsPage() {
  return (
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Romantic</span>
        </div>
      </div>
      <section className="container mx-auto px-4 py-4 bg-white">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Romantic Decorations</h1>
        <p className="text-gray-700 mb-4">{romanticPackages.length * 100 + 500} reviews</p>
      </section>
      <section className="container mx-auto px-4 py-4 border-t border-b border-gray-200 bg-white">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-500">{romanticPackages.length * 100 + 500} reviews</span>
          </div>
        </div>
      </section>
