...
export const metadata = {
  title: "Premium Gifts | MaaChao Gifts",
  description: "Find the best premium gifts for all occasions.",
};

const premiumGifts = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Premium Gift #${i + 1}`,
    ...
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Premium Gifts</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Premium Gifts</h1>
