...
export const metadata = {
  title: "Hampers Gifts | MaaChao Gifts",
  description: "Find the best hampers to gift for all occasions.",
};

const hampersGifts = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
...
export default function HampersGiftsPage() {
  return (
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Hampers</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Hampers Gifts</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
          {hampersGifts.map((gift) => (
