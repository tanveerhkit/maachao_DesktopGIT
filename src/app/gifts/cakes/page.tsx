...
export const metadata = {
  title: "Cakes Gifts | MaaChao Gifts",
  description: "Find the best cakes to gift for all occasions.",
};

const cakesGifts = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Delicious Cake Gift #${i + 1}`,
...
export default function CakesGiftsPage() {
  return (
    <MainLayout>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Cakes Gifts</h1>
