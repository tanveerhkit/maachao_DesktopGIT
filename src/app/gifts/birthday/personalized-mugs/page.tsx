...
export const metadata = {
  title: "Birthday Personalized Mugs Gifts | MaaChao Gifts",
  description: "Find the best personalized mugs for birthday gifts.",
};

const mugsGifts = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Birthday Personalized Mug #${i + 1}`,
...
export default function BirthdayPersonalizedMugsPage() {
  return (
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <Link href="/gifts/birthday" className="hover:text-brand-orange">Birthday</Link>
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Personalized mugs</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Birthday Personalized Mugs Gifts</h1>
