...
export const metadata = {
  title: "Birthday Chocolates Gifts | MaaChao Gifts",
  description: "Find the best chocolates for birthday gifts.",
};

const chocolatesGifts = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  name: `Birthday Chocolate Gift #${i + 1}`,
...
export default function BirthdayChocolatesPage() {
  return (
    <MainLayout>
      <div className="w-full bg-white py-4 text-sm">
        <div className="container mx-auto px-4 flex items-center text-black">
          ...
          <span className="mx-2">/</span>
          <span className="text-brand-orange font-semibold">Chocolates</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 py-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Birthday Chocolates Gifts</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
          {chocolatesGifts.map((gift) => (
