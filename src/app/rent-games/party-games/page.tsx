...
const partyGameProducts = [
    {
        id: 1,
        name: "Cards Against Humanity",
        image: "/placeholder-cah.jpg",
        price: 999,
        rating: 4.9,
        reviews: 350,
        type: "Card Game"
    ...
    {
        id: 2,
        name: "Beer Pong Table & Kit",
        image: "/placeholder-beerpong.jpg",
        price: 1599,
        rating: 4.8,
        reviews: 210,
        type: "Drinking Game"
    ...
    {
        id: 3,
        name: "Twister Ultimate",
        image: "/placeholder-twister.jpg",
        price: 799,
        rating: 4.7,
        reviews: 180,
        type: "Physical Game"
    ...
    {
        id: 4,
        name: "Karaoke Machine & Mics",
        image: "/placeholder-karaoke.jpg",
        price: 2499,
        rating: 4.9,
        reviews: 280,
        type: "Entertainment"
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-10">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Icebreakers and crowd-pleasers to get your party started and keep it going all night.
            </p>
          </div>
